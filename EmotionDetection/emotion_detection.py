...
def emotion_detector(text_to_analyse):
    ...
    if response.status_code == 200:
        ...
        dominant_emotion = max(response.json()['emotionPredictions'][0]['emotion'],
                               key=response.json()['emotionPredictions'][0]['emotion'].get)
    ...
    retval = {"anger": anger, "disgust": disgust, "fear": fear, "joy": joy, "sadness": sadness,
